# View my "Design-and-functional-analysis-of-the-BMW-E39-transmission-and-drive-shaft-system" project.
...
* **Structural Safety & Compliance:** The analytical stress verification proved that under peak torque conditions, the calculated torsional stress  remains well below the allowable material threshold ($\tau_{at} = 300\text{ N/mm}^2$). Similarly, the twist angle ($\theta = 2.567^\circ$) respects the strict engineering boundary limits .
